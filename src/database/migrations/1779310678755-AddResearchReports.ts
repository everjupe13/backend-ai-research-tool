...
export class AddResearchReports1779310678755 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."research_reports_status_enum" AS ENUM('pending', 'processing', 'done', 'failed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "research_reports" ADD CONSTRAINT "FK_6f20643a4ca664cae7c3ae78191" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "research_reports" DROP CONSTRAINT "FK_6f20643a4ca664cae7c3ae78191"`,
    );
    await queryRunner.query(`DROP TABLE "research_reports"`);
    await queryRunner.query(
      `DROP TYPE "public"."research_reports_status_enum"`,
    );
  }
}
